...
namespace Microsoft.CodeAnalysis.Snippets
{
    internal static class RoslynLSPSnippetConverter
    {
        ...
        /// </summary>
        public static async Task<string> GenerateLSPSnippetAsync(Document document, int caretPosition, int triggerLocation, ImmutableArray<SnippetPlaceholder> placeholders, TextChange textChange, CancellationToken cancellationToken)
        {
